 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "- **Si un GPU est disponible**, il est utilisé par défaut (le code est optimisé même pour de petits graphes grâce aux noyaux CUDA personnalisés qui évitent la création de matrices creuses à chaque itération).\n",
    "- **Sinon**, le code s'exécute sur CPU via NumPy et SciPy."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "        \n",
    "        # 10 itérations suffisent pour des graphes de type grille jusqu'à L=1000\n",
    "        for _ in range(10):\n",
